...
public class ListViewAdapter2 extends BaseAdapter {
    ...
    public ListViewAdapter2(Context context, List<WorldPopulation> worldpopulationlist) {
        mContext = context;
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        holder.imageView.setImageUrl("http://10.0.2.2/wisataCilacap/images/" + worldpopulationlist.get(position).getCountry(), mImageLoader);
